...
def iso_2auto(train_dataset,test_dataset):
  ...
  ax.plot(history1.history['loss'], 'b', label='Train 1', linewidth=2)
  ax.plot(history2.history['loss'], 'r', label='Train 2', linewidth=2)
  ax.set_title('Model loss', fontsize=16)
  ax.set_ylabel('Loss (mae)')
  ax.set_xlabel('Epoch')
  ax.legend(loc='upper right')
  plt.savefig('./result/2auto+iso_loss.png')
